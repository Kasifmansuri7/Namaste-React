...
function Header() {
  ...
  return (
    <header className="flex justify-between p-4 mt-2 fixed w-full">
      <Link to="/">
      ...
      <div className="flex">
        ...
        <Link to="/grocery">
          <svg
            ...
            strokeWidth="2.5"
            stroke="currentColor"
            className="w-8 h-8 inline-block  text-amber-500 font-bold "
          >
            <path
              strokeLinecap="round"
          ...
          <h3 className="m-2 inline-block  text-amber-500 font-bold text-lg">
